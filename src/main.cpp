...
int main()
{
    ...
    gameObjects.push_back(std::make_unique<GameObject>("sword", "resources/objects/sword/sting.obj", true, objectShader, swordModelMatrix, gameObjects));
    gameObjects.push_back(std::make_unique<GameObject>("sword", "resources/objects/sword/sting.obj", true, objectShader, gameObjects));
    gameObjects.push_back(std::make_unique<GameObject>("sword", "resources/objects/sword/sting.obj", true, objectShader, gameObjects));
    gameObjects.push_back(std::make_unique<GameObject>("sword", "resources/objects/sword/sting.obj", true, objectShader, gameObjects));
